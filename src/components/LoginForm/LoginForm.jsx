...
export const LoginForm = observer(() => {
      ...
      if (error) {
        if (error === "Error: Email is not verified!") {
          notification.open({
            ...
            description: (
              <ErrorDescNotVerified emailOrUsername={emailOrUsername} />
            ),
  ...
  return isRecovery ? (
    ...
    <div className="login__full">
      <div
        className={`login__header ${pageStore.selectedTheme === "light" ? "lightColorTheme__Text" : "darkColorTheme__Text"}`}
      >
      ...
      >
        ...
        >
          <Checkbox
            className={`login__remember ${pageStore.selectedTheme === "light" ? "lightColorTheme__Text" : "darkColorTheme__Text"}`}
          >
            {t("login.rememberMe")}
          </Checkbox>
        </Form.Item>
